...
<div class="nk-content">
     ...
     <div class="nk-block-head">
          <div class="nk-block-head-content">
              <h4 class="nk-block-title">Term & Conditon Page</h4>
          </div>
      </div>
                                   ...
                                   <div class="d-flex justify-content-between align-items-center">
                                        <div class="nk-block-head-content butn-cls">
                                             <div class="mbsc-form-group view_btn">
                                                  {{-- <a href="{{ url('/terminos-y-condiciones') }}" class="view_page" target="_blank">View Page</a> --}}
                                                  <a href="{{ url('/terms-conditions') }}" class="view_page" target="_blank">View Page</a>
                                             </div>
                                        </div>
                                        <div class="nk-block-head-content">
