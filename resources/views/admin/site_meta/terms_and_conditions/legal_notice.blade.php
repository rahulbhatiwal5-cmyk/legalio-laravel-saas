...
<div class="nk-content">
     ...
     <div class="nk-block-head">
          <div class="nk-block-head-content">
              <h4 class="nk-block-title">Legal Notice</h4>
          </div>
      </div>
     ...
     <div class="container-fluid">
          ...
          <form action="{{ url('/admin-dashboard/legal-notice-process') }}" method="post" enctype="multipart/form-data">
               @csrf
               ...
               <div class="row main_section">
                    <div class="col-md-12 left-content">
                         ...
                         @if(isset($legal_notice) && $legal_notice->isNotEmpty())
                         @foreach($legal_notice as $index=>$value)
                                   ...
                                   <div class="d-flex justify-content-between align-items-center">
                                        <div class="nk-block-head-content butn-cls">
                                             <div class="mbsc-form-group view_btn">
                                                  {{-- <a href="{{ url('/aviso-legal') }}" class="view_page" target="_blank">View Page</a> --}}
                                             </div>
                                        </div>
                                        <div class="nk-block-head-content">
