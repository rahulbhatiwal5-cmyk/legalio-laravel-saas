...
<div class="nk-content Carta_Voluntaria">
     <div class="container-fluid">
          <form action="{{ url('/admin-dashboard/update-document-right-content') }}" id="updatecontentForm" method="post" enctype="multipart/form-data">
               ...
               <input type="hidden" id="documentId" name="documentId" value="{{ $_GET['id'] ?? '' }}">
               <input type="hidden" id="changed_content_type" name="changed_content_type" value=[]>
               <!-- <input type="hidden" id="signature_field_hidden" name="signature_field_hidden" value=""> -->
                    ...
                    <div class="nk-block-head-content wrapper">
                         <div class="tab">
                              ...
                              <a href="{{ route('admin.dashboard.edit_documents',['slug' => $document->slug]) }}"
                                   class="btn tab_btn" target="_blank">Frontpage</a>
                              @else
                              ...
                              @if(isset($document) && $document != null)
                              <a href="{{ url('/admin-dashboard/document-contract-edit?id='.$document->id) }}" target="_blank" class="btn tab_btn" id="tab-contract">Contract Editor</a>
                              @else
               ...
               <div class="row main_section mt-4 updated-rw" >
