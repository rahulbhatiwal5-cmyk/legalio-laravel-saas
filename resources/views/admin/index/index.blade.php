                                       ...
                                       <div class="card card-bordered card-full">
                                           <div class="card-inner">
                                               ...
                                               <div class="card-amount">
                                                   <span class="amount" id ="totalSales">{{number_format($totalSales, 2)}} <span class="currency currency-usd">USD</span></span>
                                               ...
                                               <div class="invest-data">
                                                   <div class="invest-data-amount g-2">
                                                       <div class="invest-data-history">
                                                           ...
                                                           <div class="amount"  id="thisMonthSales" ></div>
                                                       </div>
                                                       <div class="invest-data-history">
                                                           <div class="title">This Week</div>
                                                           <div class="amount" id="thisWeekSales" ></div>
                                                       </div>
                                                   </div>
                                       ...
                                       <div class="card card-bordered card-full">
                                           <div class="card-inner">
                                               <div class="card-title-group align-start mb-0">
                                                   ...
                                                   <div class="card-tools">
                                                       <em class="card-hint icon ni ni-help-fill" data-bs-toggle="tooltip" data-bs-placement="left" title="Total orders"></em>
                                                   </div>
                                               </div>
                                               <div class="card-amount">
                                                   <span class="amount" id="totalOrder" >{{$order->count()}} </span>
                                               ...
                                               <div class="invest-data">
                                                   <div class="invest-data-amount g-2">
                                                       <div class="invest-data-history">
                                                           <div class="title">This Month</div>
                                                           <div class="amount" id="thisMonthOrders"></div>
                                                       </div>
                                                       <div class="invest-data-history">
                                                           <div class="title">This Week</div>
                                                           <div class="amount" id="thisWeekOrders" ></div>
                                                       </div>
                                                   </div>
                                                   <div class="invest-data-ck">
                                   ...
                                   <div class="col-md-6">
                                       <div class="card card-bordered card-full">
                                           <div class="card-inner">
                                               <div class="card-title-group align-start mb-0">
                                                   <div class="card-title">
                                                       <h6 class="subtitle">Total Documents</h6>
                                                   </div>
                                                   <div class="card-tools">
                                                       <em class="card-hint icon ni ni-help-fill" data-bs-toggle="tooltip" data-bs-placement="left" title="Total Documents"></em>
                                                   </div>
                                               </div>
                                               <div class="card-amount">
                                                   <span class="amount" id="totalDocument">{{$document->count()}} </span>
                                               </div>
                                               <div class="invest-data">
                                                   <div class="invest-data-amount g-2">
                                                       <div class="invest-data-history">
                                                           <div class="title">This Month</div>
                                                           <div class="amount" id="thisMonthDocuments"></div>
                                                       </div>
                                                       <div class="invest-data-history">
                                                           <div class="title">This Week</div>
                                                           <div class="amount" id="thisWeekDocuments"></div>
                                                       </div>
                                                   </div>
                                                   <div class="invest-data-ck">
                                       ...
                                       <div class="card card-bordered card-full">
                                           <div class="card-inner">
                                               <div class="card-title-group align-start mb-0">
                                                   ...
                                                   <div class="card-tools">
                                                       <em class="card-hint icon ni ni-help-fill" data-bs-toggle="tooltip" data-bs-placement="left" title="Total Users"></em>
                                                   </div>
                                               </div>
                                               <div class="card-amount">
                                                   <span class="amount" id="totaluser">{{$user->count()}} </span>
                                               </div>
                                               <div class="invest-data">
                                                   <div class="invest-data-amount g-2">
                                                       <div class="invest-data-history">
                                                           <div class="title" >This Month</div>
                                                           <div class="amount" id="thisMonthUsers"></div>
                                                       </div>
                                                       <div class="invest-data-history">
                                                           <div class="title">This Week</div>
                                                           <div class="amount" id="thisWeekUsers"> </div>
                                                       </div>
                                                   </div>
                                                   <div class="invest-data-ck">
                                                       <canvas class="iv-data-chart" id="totalBalance"></canvas>
...
<script type="text/javascript">
     $(function() {
         ...
         function cb(start, end) {
             ...
             // Automatically trigger AJAX call on date change
         ...
         cb(start, end); // Initial call to load default data
     });
     ...
     function fetchFilteredData(startDate, endDate) {
         $.ajax({
             ...
             success: function(response) {
                 ...
                 $('#totalDocument').html(response.totalDocument);
                 $('#totaluser').html(response.totaluser);

                  // This Month's data
               $('#thisMonthSales').html(response.thisMonthSales + ' <span class="currency currency-usd">USD</span>');
               $('#thisMonthOrders').html(response.thisMonthOrders);
               $('#thisMonthDocuments').html(response.thisMonthDocuments);
               $('#thisMonthUsers').html(response.thisMonthUsers);

               // This Week's data
               $('#thisWeekSales').html(response.thisWeekSales + ' <span class="currency currency-usd">USD</span>');
               $('#thisWeekOrders').html(response.thisWeekOrders);
               $('#thisWeekDocuments').html(response.thisWeekDocuments);
     ...
     // Trigger AJAX on search button click
