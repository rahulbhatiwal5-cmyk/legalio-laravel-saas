...
<div class="nk-content">
    <div class="container-fluid">
        <form action="{{route('knowledge.base.update.article')}}" method="post" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="card card-bordered card-preview">
                        <div class="card-inner">
                            ...
                            <div class="row gy-12 mt-2">
                                 <div class="col-md-12 doc-short-des">
                                      <div class="form-group">
                                           ...
                                           <textarea class="form-control" id="seo_description" name="seo_description">{{ old('seo_description', $article->seo_description ?? '') }}</textarea>
                            ...
                            <div class="row gy-12 mt-2">
                                <div class="col-md-12 doc-short-des">
                                     <div class="form-group">
                                          ...
                                          {{-- <textarea class="form-control" id="article_overview" name="article_overview"></textarea> --}}
                                          <textarea class="form-control" id="article_overview" name="article_overview">{{ old('article_overview', $article->article_overview ?? '') }}</textarea>
                          ...
                          <hr>
                            ...
                            <div id="parent_div">
                                @if(isset($article->contents) && count($article->contents))
                                @foreach($article->contents as $content)
                                    <div class="row mt-2 clone-div">
                                        <div class="col-md-12 mt-2">
                                            <div class="form-group">
                                                <label class="form-label"><b>Content Heading</b></label>
                                                <input type="text" class="form-control form-control-lg" name="content_heading[]" placeholder="Enter heading" value="{{ $content->content_heading }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12 mt-2">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control content-description" name="content_description[]" placeholder="Enter description...">{{ $content->content_description }}</textarea>
                                            </div>
                                        </div>
                                ...
                                @endforeach
                            @else
                                <!-- fallback single empty input set (default) -->
                                <div class="row mt-2 clone-div">
                                    <div class="col-md-12 mt-2">
                                        <div class="form-group">
                                            <label class="form-label"><b>Content Heading</b></label>
                        ...
                        <div class="card-inner">
                            ...
                            {{-- <div class="col-md-12 mt-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="meta_title" name="meta_title" maxlength="50" value="{{$article->meta_title}}">
                                </div>
                            </div>
                            <div class="col-md-12 mt-2">
                                <div class="form-group">
                                    <label class="form-label" for="meta_description">Meta Description</label>
                                    <textarea class="form-control" id="meta_description" name="meta_description" maxlength="155">{{$article->meta_description}}</textarea>
                                </div>
                            </div> --}}
