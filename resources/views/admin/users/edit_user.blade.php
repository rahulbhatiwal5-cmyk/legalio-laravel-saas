                                ...
                                <div class="col-lg-12 p-3 form-group mb-3">
                                    ...
                                    <div class="form-control-wrap">
                                        <select class="form-select form-control-lg" name="is_admin" id="role">
                                            ...
                                            <option value="1" {{ isset($user->is_admin) && $user->is_admin == 1 ? 'selected' : '' }}>Super Admin</option>
                                            {{-- <option value="2" {{ isset($user->is_admin) && $user->is_admin == 2 ? 'selected' : '' }}>Contract Description Editor</option>
                                            <option value="3" {{ isset($user->is_admin) && $user->is_admin == 3 ? 'selected' : '' }}>User Support Agent</option> --}}
                                        </select>
                                    </div>
                                </div>
                            </div>
