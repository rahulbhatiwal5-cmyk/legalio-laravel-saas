...
<div class="invoice-print">
    <div class="invoice-wrap">
        <div class="invoice-brand text-center">
            <img src="{{ asset('assets/img/logo-legalio-mx-new.svg') }}"
                 srcset="{{ asset('assets/img/logo-legalio-mx-new.svg') }} 2x" alt="">
        ...
        <div class="invoice-head">
            <!--<div class="invoice-contact">
                ...
                <div class="invoice-contact-info">
                    <h4 class="title">{{ $customer_name ?? 'Customer Name' }}</h4>
                    <ul class="list-plain">
                        <li>
                            <em class="icon ni ni-map-pin-fill fs-18px"></em>
                            <span>{!! nl2br(e($customer_address ?? 'Customer Address')) !!}</span>
                        </li>
                        <li>
                            {{-- <em class="icon ni ni-call-fill fs-14px"></em> --}}
                            <em class="icon ni ni-mail-fill fs-14px "></em>
                            <span>{{ $customer_email ?? 'N/A' }}</span>
                        </li>
                    </ul>
                </div>
            </div>-->
            ...
            <div class="invoice-desc">
                ...
                <ul class="list-plain">
                    ...
                    <li class="invoice-date"><span>Date :</span> <span>{{ $invoice_date ?? now()->format('d M, Y') }}</span></li>
                    ...
                    <tbody>
                        ...
                        <tr class="tableBorder">
                            <td class="tableBorder">
                                @if(!empty($item['image']))
                                    <img src="{{ asset($item['image']) }}" alt="Document Image" style="width: 60px; height: auto;">
                                @else
                                    N/A
                                @endif
                            </td>
                            ...
                            <td class="tableBorder">${{ number_format($item['price'] * $item['quantity'], 2) }}</td>
                        </tr>
                        @endforeach
                    </tbody>
