                    ...
                    <div class="card-inner">
                         ...
                         <div class="col-md-8 mt-2">
                              <div class="form-group">
                                   ...
                                   <input type="number" class="form-control" id="number_of_months" name="number_of_months" placeholder="Enter Number of Months" value="">
                              </div>    
                         ...
                         <div class="col-md-8 mt-2">
                              <div class="form-group">
                                   ...
                                   <input type="text" class="form-control" id="plan_amount" name="plan_amount" placeholder="Enter Plan Amount" value="{{ $plan->price ?? '' }}">                   
                              </div>  
