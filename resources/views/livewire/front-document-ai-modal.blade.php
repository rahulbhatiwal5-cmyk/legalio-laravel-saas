...
<div x-data="{ open: @entangle('show'),
               ...
               " x-init="window.addEventListener('openAiModal',  (event) => {
         open = true;
            ...
            <div class="modal-content">
                            ...
                            <template x-if="!loading">
                                <div class="card ai-response-container ">
                                    ...
                                    <div class="ai-response-box p-3">
                                        <p class="ai-response-text" x-text="ai_output" id="ai-output">
                ...
                <div class="modal-footer bg-light ">
                    <div>
                        ...
                        <button type="button" onclick="getOutput()" @click="open = false" class="btn btn-primary"> Confirm and Save </button>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    window.addEventListener('processAiPrompt', event => {
        @this.call('sendPrompt');
    });
